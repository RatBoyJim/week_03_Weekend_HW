class Game():
    def play_game(player_1, player_2):
        if player_1.choice == "Rock" and player_2.choice == "Scissors":
            return f"{player_1.name} is the winner because {player_1.choice} beats {player_2.choice}"
            ...
            return f"{player_2.name} is the winner because {player_2.choice} beats {player_1.choice}"
